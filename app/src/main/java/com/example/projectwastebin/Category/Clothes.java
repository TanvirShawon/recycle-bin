...
public class Clothes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchList= findViewById(R.id.clothes_list);
        searchList.setLayoutManager(new LinearLayoutManager(Clothes.this));
                    ...
                    protected void onBindViewHolder(@NonNull ProductViewHolder holder, int i, @NonNull Products model) {
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                Intent intent= new Intent(Clothes.this, ProductDetailsActivity.class);
