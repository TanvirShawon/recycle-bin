...
public class PlasticBottle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_plastic_bottle);

        searchInput="Plastic Bottle";

        searchList= findViewById(R.id.plastic_bottles_list);
        searchList.setLayoutManager(new LinearLayoutManager(PlasticBottle.this));
                    ...
                    protected void onBindViewHolder(@NonNull ProductViewHolder holder, int i, @NonNull Products model) {
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                Intent intent= new Intent(PlasticBottle.this, ProductDetailsActivity.class);
