...
public class Vehicles extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchList= findViewById(R.id.vehicles_list);
        searchList.setLayoutManager(new LinearLayoutManager(Vehicles.this));
                    ...
                    protected void onBindViewHolder(@NonNull ProductViewHolder holder, int i, @NonNull Products model) {
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                Intent intent= new Intent(Vehicles.this, ProductDetailsActivity.class);
