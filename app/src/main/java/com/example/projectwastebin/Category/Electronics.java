...
public class Electronics extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchList= findViewById(R.id.electronics_list);
        searchList.setLayoutManager(new LinearLayoutManager(Electronics.this));
                    ...
                    protected void onBindViewHolder(@NonNull ProductViewHolder holder, int i, @NonNull Products model) {
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                Intent intent= new Intent(Electronics.this, ProductDetailsActivity.class);
