...
public class BrokenPlastic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_broken_plastic);

        searchInput="Broken Plastic";

        searchList= findViewById(R.id.broken_plastic_list);
        searchList.setLayoutManager(new LinearLayoutManager(BrokenPlastic.this));
                    ...
                    protected void onBindViewHolder(@NonNull ProductViewHolder holder, int i, @NonNull Products model) {
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                Intent intent= new Intent(BrokenPlastic.this, ProductDetailsActivity.class);
