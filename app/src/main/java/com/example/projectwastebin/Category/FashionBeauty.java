...
public class FashionBeauty extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchInput="fashion Beauty";

        searchList= findViewById(R.id.fashion_beauty_list);
        searchList.setLayoutManager(new LinearLayoutManager(FashionBeauty.this));
                    ...
                    protected void onBindViewHolder(@NonNull ProductViewHolder holder, int i, @NonNull Products model) {
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                Intent intent= new Intent(FashionBeauty.this, ProductDetailsActivity.class);
