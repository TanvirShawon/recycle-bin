...
public class PlantNursery extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_plant_nursery);

        searchInput="Plant Nursery";

        searchList= findViewById(R.id.plant_nursery_list);
        searchList.setLayoutManager(new LinearLayoutManager(PlantNursery.this));
                    ...
                    protected void onBindViewHolder(@NonNull ProductViewHolder holder, int i, @NonNull Products model) {
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                Intent intent= new Intent(PlantNursery.this, ProductDetailsActivity.class);
