...
public class Newspaper extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchInput="Newspaper";

        searchList= findViewById(R.id.newspaper_list);
        searchList.setLayoutManager(new LinearLayoutManager(Newspaper.this));
                    ...
                    protected void onBindViewHolder(@NonNull ProductViewHolder holder, int i, @NonNull Products model) {
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                Intent intent= new Intent(Newspaper.this, ProductDetailsActivity.class);
