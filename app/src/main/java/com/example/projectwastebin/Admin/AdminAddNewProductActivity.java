...
public class AdminAddNewProductActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        InputDistrict= findViewById(R.id.product_district);
        InputAddress= findViewById(R.id.product_address);
        InputPhone= findViewById(R.id.product_phone);
    ...
    private void StoreProductInformation()
    {
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            {
             //   Toast.makeText(AdminAddNewProductActivity.this, "Posted Successfully...", Toast.LENGTH_SHORT).show();
