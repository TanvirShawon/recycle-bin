        ...
        FirebaseRecyclerAdapter<Cart, CartViewHolder> adapter = new FirebaseRecyclerAdapter<Cart, CartViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull CartViewHolder holder, int i, @NonNull Cart model) {
             //   holder.txtProductQuantity.setText("Quantity = " + model.getQuantity());
                ...
                holder.txtSellerAddress.setText(model.getPaddress()+", "+model.getPdistrict());
                holder.txtSellerEmail.setText(model.getSellerEmail());
            ...
            public CartViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.cart_items_layout_admin, parent, false);
