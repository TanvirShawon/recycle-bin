...
import com.example.projectwastebin.Admin.AdminMaintainProductsActivity;
import com.example.projectwastebin.Admin.AdminNewOrderActivity;
import com.example.projectwastebin.Admin.AdminUserProductsActivity;
...
//        if (id == R.id.action_settings)  nainai
//        {
//            return true;
//        }
    ...
    public boolean onNavigationItemSelected(MenuItem item)
    {
...

        {
            if (!type.equals("Admin")){
                ...
                Intent intent = new Intent(HomeActivity.this, AllOrders.class);
...

        {
            if (!type.equals("Admin")){
                ...
                Intent intent = new Intent(HomeActivity.this, RateUs.class);
                startActivity(intent);
            }
